...
<section class="newsletter-section"
    ...
    <div class="newsletter-container">
        ...
        <form id="newsletter-form" class="newsletter-form" method="post">
            <div id="response" class="newsletter-response hidden"></div>
            ...
            <button type="submit" class="newsletter-submit" title="Subscribe">SIGN UP</button>
        </form>

        <div class="newsletter-socials">
            <?php if (!empty($socials)) : ?>
                <?php foreach ($socials as $social) : ?>
                    <a href="<?php echo esc_url($social['url']); ?>" class="newsletter-social-link" target="_blank"><?php echo esc_html($social['name']); ?></a>
                    <?php if (!$loop->last) : ?>
